  ...
  return (
    <div className="container mx-auto my-0 flex h-dvh max-w-lg flex-col items-center justify-center p-5">
      ...
      <p className="mb-5 text-center text-gray-700">
        Merci de vous être inscrit sur Hero App! Un email de confirmation a été
        envoyé à votre adresse email. Veuillez suivre les instructions dans
        l'email pour confirmer votre compte.
      </p>
